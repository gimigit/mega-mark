...
export default function BrowseByCategory({ categoryId, categoryName }: BrowseByCategoryProps) {
        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-8">
          <div className="flex-1">
            <h2 className="text-2xl font-bold mb-4">
              {categoryName} — {totalCount} anunturi
            </h2>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            <Select value={filters.country} onValueChange={handleCountryChange}>
              ...
              <SelectContent>
                <SelectItem value="all">Toate tarile</SelectItem>
                {EU_COUNTRIES.map(c => (
            ...
            <Select value={filters.condition} onValueChange={handleConditionChange}>
              ...
              <SelectContent>
                ...
                <SelectItem value="refurbished">Reconditionat</SelectItem>
              </SelectContent>
            </Select>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            <p className="text-muted-foreground text-lg">
              Nu sunt anunturi pentru {categoryName} momentan.
            </p>
            <p className="text-muted-foreground mt-2">
              Fii primul care publica un anunt!
            </p>
            <Link href="/listings/create">
              <Button className="mt-4">Publica anunt</Button>
            </Link>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
