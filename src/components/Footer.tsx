...
const footerLinks = {
  ...
  categories: [
    { href: '/browse?category=tractors', label: 'Tractoare' },
    { href: '/browse?category=combines', label: 'Combine' },
    { href: '/browse?category=harvesters', label: 'Recoltoare' },
    { href: '/browse?category=sprayers', label: 'Stropitori' },
    { href: '/browse?category=seeders', label: 'Semanatori' },
    { href: '/browse?category=plows', label: 'Pluguri' },
    { href: '/browse?category=balers', label: 'Prese balotat' },
    { href: '/browse?category=loaders', label: 'Incarcatoare' },
    { href: '/browse?category=trailers', label: 'Remorci' },
    { href: '/browse?category=construction', label: 'Utilaje constructii' },
  ],
  brands: [
