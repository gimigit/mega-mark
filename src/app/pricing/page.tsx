...
export const metadata: Metadata = {
  title: 'Planuri și Prețuri | AgroMark EU',
  description: 'Explorează planurile de abonament și prețurile pentru AgroMark EU. Free, Seller, Dealer, Enterprise plus boosturi pentru anunțuri.',
}
    ...
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <a href="/" className="text-2xl font-bold text-green-700">AgroMark EU</a>
        ...
        <div>
          ...
          <div className="space-y-4 max-w-3xl">
            ...
            <div className="border-b pb-4">
              ...
              <p className="text-gray-600">Da, poți anula abonamentul în orice moment. Accesul rămâne activ până la sfârșitul perioadei de facturare.</p>
            </div>
            <div className="border-b pb-4">
      ...
      <footer className="bg-gray-900 text-gray-300 py-8 mt-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p>&copy; 2025 AgroMark EU. Toate drepturile rezervate.</p>
        </div>
      </footer>
    </div>
  )
