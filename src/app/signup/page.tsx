      ...
      <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-green-950 flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl shadow-2xl p-10 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-8">
            Am trimis un link de confirmare la <strong>{form.email}</strong>. După confirmare vei fi redirecționat automat către dashboard.
          </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-green-950 flex items-center justify-center p-6">
      <div className="bg-white rounded-2xl shadow-2xl p-10 max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">Creează un cont gratuit</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <p className="text-xs text-gray-400 text-center">
            ...
            <a href="/terms" className="underline hover:text-green-700">Termenii și Condițiile</a> și{' '}
            <a href="/privacy" className="underline hover:text-green-700">Politica de Confidențialitate</a>.
          </p>
        </form>

        <div className="border-t border-gray-100 mt-6 pt-6">
          <p className="text-sm text-gray-500 text-center mb-4">sau creează cont cu</p>
